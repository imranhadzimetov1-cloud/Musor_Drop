...
const SKINS_DATABASE = [
    ...
    { id: 112, weapon: "Galil AR", name: "Galil AR | Cerberus", rarity: "COMMON", price: 5, img: "galil-camo.png" },
    ...
    { id: 31, weapon: "AK-47", name: "AK-47 | Ice Coaled", rarity: "EPIC", price: 110, img: "ak-neon.png" },
    { id: 32, weapon: "AWP", name: "AWP | Fever Dream", rarity: "EPIC", price: 95, img: "awp-headshot.png"  },
    { id: 33, weapon: "USP-S", name: "USP-S | Neo-Noir", rarity: "EPIC", price: 125, img: "usp-noir.png" },
    { id: 34, weapon: "M4A4", name: "M4A4 | Neo-Noir", rarity: "EPIC", price: 140, img: "m4a4-hyper.png" },
    { id: 102, weapon: "Glock-18", name: "Glock-18 | Moonrise", rarity: "EPIC", price: 85, img: "glock.png" },
    { id: 36, weapon: "Desert Eagle", name: "Desert Eagle | Conspiracy", rarity: "EPIC", price: 105, img: "deagle-fizy.png" },
    { id: 50, weapon: "AK-47", name: "AK-47 | Neon Rider", rarity: "LEGENDARY", price: 380, img: "ak-neon-rider.png" },
    { id: 51, weapon: "AWP", name: "AWP | Asiimov", rarity: "LEGENDARY", price: 490, img: "awp-asiimov.png" },
    { id: 52, weapon: "Desert Eagle", name: "Desert Eagle | Printstream", rarity: "LEGENDARY", price: 450, img: "deagle-printstream2.png" },
    { id: 53, weapon: "M4A1-S", name: "M4A1-S | Player Two", rarity: "LEGENDARY", price: 410, img: "m4a4-headshot.png" },
    { id: 54, weapon: "AK-47", name: "AK-47 | Bloodsport", rarity: "LEGENDARY", price: 520, img: "ak-voltaic.png" },
...
SKINS_DATABASE.forEach(skin => {
    // Если у скина НЕТ своей картинки — генерируем
    if (!skin.img) {
...
function renderSapperGrid() {
    ...
    container.innerHTML = sapperGame.grid.map((value, index) => {
        ...
        return `
            <div onclick="sapperClick(${index})" style="
                ...
                font-weight: 900;
                color: ${textColor};
                cursor: ${sapperGame.isGameOver || !sapperGame.selectedSkin ? 'not-allowed' : 'pointer'};
...
function setBetAmount(amount) {
    ...
    if (amount > maxAvailable) {
        showToast(`⚠️ У вас только ${maxAvailable} скинов!`);
        amount = maxAvailable;
    }
    if (amount < 1) {
